import{initializeApp as Ee}from"https://www.gstatic.com/firebasejs/10.14.1/firebase-app.js";import{getAuth as Ae,onAuthStateChanged as he,signOut as Ce}from"https://www.gstatic.com/firebasejs/10.14.1/firebase-auth.js";import{getFirestore as Ie,setDoc as M,doc as y,serverTimestamp as F,getDocs as P,query as D,collection as T,where as R,onSnapshot as V,addDoc as $e,deleteDoc as G}from"https://www.gstatic.com/firebasejs/10.14.1/firebase-firestore.js";(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const n of document.querySelectorAll('link[rel="modulepreload"]'))a(n);new MutationObserver(n=>{for(const s of n)if(s.type==="childList")for(const i of s.addedNodes)i.tagName==="LINK"&&i.rel==="modulepreload"&&a(i)}).observe(document,{childList:!0,subtree:!0});function o(n){const s={};return n.integrity&&(s.integrity=n.integrity),n.referrerPolicy&&(s.referrerPolicy=n.referrerPolicy),n.crossOrigin==="use-credentials"?s.credentials="include":n.crossOrigin==="anonymous"?s.credentials="omit":s.credentials="same-origin",s}function a(n){if(n.ep)return;n.ep=!0;const s=o(n);fetch(n.href,s)}})();const Be={apiKey:"AIzaSyCLIRUnVlNb7U4O8vEeW02XeNHKN6rOS5s",authDomain:"controlefinanceiro-b74e2.firebaseapp.com",projectId:"controlefinanceiro-b74e2",storageBucket:"controlefinanceiro-b74e2.firebasestorage.app",messagingSenderId:"118974166959",appId:"1:118974166959:web:a5fe420ee87da27980e15a",measurementId:"G-R1XVXLGBPW"},me=Ee(Be),ue=Ae(me),p=Ie(me),$="users",ee="entradas",_="faturas",te="boletos",pe="reservas";let u=null,m=null,S=[],x=[],B=[],U=null,W=null,X=null,Y=null,Q=null;window.brl=function(t){return(t||0).toLocaleString("pt-BR",{style:"currency",currency:"BRL"})};window.fmtData=function(t){if(!t)return"—";try{const e=new Date(t);return isNaN(e.getTime())?t:e.toLocaleDateString("pt-BR")}catch{return t}};window.toastMsg=function(t){const e=document.getElementById("toast-box");if(!e)return;const o=document.createElement("div");o.className="toast",o.innerHTML=t,e.appendChild(o),setTimeout(()=>o.remove(),4e3)};document.querySelectorAll(".nav-tab").forEach(t=>{t.addEventListener("click",()=>{const e=t.getAttribute("data-tab");goTab(e)})});window.goTab=function(t){document.querySelectorAll(".nav-tab").forEach(a=>a.classList.remove("active")),document.querySelectorAll(".tab-content").forEach(a=>a.classList.remove("active"));const e=document.querySelector(`.nav-tab[data-tab="${t}"]`);e&&e.classList.add("active");const o=document.getElementById(t);o&&o.classList.add("active")};const C="victorhomota@gmail.com",ge="220101cod";async function H(t,e){u=t,localStorage.setItem("cf_custom_session",JSON.stringify(t)),document.getElementById("modal-auth").style.display="none",document.getElementById("user-profile-bar").style.display="flex";try{await oe(t.uid)}catch(o){console.warn("Perfil carregado via sessão local:",o)}try{fe(t.uid)}catch(o){console.warn("Ouvintes iniciados em modo local:",o)}toastMsg(e||"🎉 Login realizado com sucesso!")}function we(){const t=localStorage.getItem("cf_custom_session");if(t)try{const e=JSON.parse(t);return H(e,"👋 Bem-vindo de volta!"),!0}catch{}return!1}he(ue,async t=>{t?(u=t,document.getElementById("modal-auth").style.display="none",document.getElementById("user-profile-bar").style.display="flex",await oe(t.uid),fe(t.uid)):we()||(u=null,m=null,ae(),document.getElementById("modal-auth").style.display="flex",document.getElementById("user-profile-bar").style.display="none")});window.alternarAbaAuth=function(t){const e=document.getElementById("form-login"),o=document.getElementById("form-register"),a=document.getElementById("btn-tab-login"),n=document.getElementById("btn-tab-register");t==="login"?(e.style.display="block",o.style.display="none",a.style.background="rgba(56,189,248,0.2)",a.style.borderColor="var(--primary)",a.style.color="var(--primary)",n.style.background="transparent",n.style.borderColor="transparent",n.style.color="var(--text-muted)"):(e.style.display="none",o.style.display="block",n.style.background="rgba(56,189,248,0.2)",n.style.borderColor="var(--primary)",n.style.color="var(--primary)",a.style.background="transparent",a.style.borderColor="transparent",a.style.color="var(--text-muted)")};async function se(t){try{await fetch("https://formsubmit.co/ajax/victorhomota@gmail.com",{method:"POST",headers:{"Content-Type":"application/json",Accept:"application/json"},body:JSON.stringify({_subject:`⏳ Novo Usuário Aguardando Aprovação: ${t.nomeUsuario}`,_template:"table",_captcha:"false","Nome do Usuário":t.nomeUsuario,"E-mail de Cadastro":t.email,"Cartão 1":t.nomeCartao1,"Cartão 2":t.nomeCartao2,Status:t.status==="ativo"?"✅ Aprovado":"⏳ Aguardando Aprovação do ADM",Perfil:t.role==="admin"?"👑 Administrador":"👤 Usuário Comum","Data do Cadastro":new Date().toLocaleString("pt-BR")})}),console.log("📬 Notificação por e-mail enviada para victorhomota@gmail.com")}catch(e){console.error("Erro ao enviar e-mail de notificação:",e)}}const ie=document.getElementById("form-login");ie&&ie.addEventListener("submit",async t=>{t.preventDefault();const e=document.getElementById("inp-login-email").value.trim(),o=document.getElementById("inp-login-password").value;if(e.toLowerCase()===C.toLowerCase())if(o===ge){const n="admin_victor_uid",s={uid:n,email:C,nomeUsuario:"Victor (Admin)",role:"admin",status:"ativo",nomeCartao1:"Cartão Principal",nomeCartao2:"Cartão Secundário"};try{await M(y(p,$,n),{...s,createdAt:F()},{merge:!0})}catch(i){console.warn("Aviso DB Admin ao logar:",i)}await H(s,"👑 Login de Administrador realizado com sucesso!");return}else{toastMsg("❌ Senha incorreta para o Administrador.");return}let a=null;try{const n=await P(D(T(p,$),R("email","==",e)));n.empty||(a=n.docs[0].data())}catch(n){console.warn("Aviso ao consultar cadastro no Firestore:",n)}if(a||(a={uid:"user_"+String(e).replace(/[^a-zA-Z0-9]/g,"_"),email:e,nomeUsuario:e.split("@")[0],role:"user",status:"pendente"}),a.status==="pendente"&&a.role!=="admin"&&a.email.toLowerCase()!==C.toLowerCase()){toastMsg("⏳ Sua conta está aguardando aprovação pelo Administrador. Você poderá acessar assim que o cadastro for aprovado!");return}await H(a,"🎉 Login realizado com sucesso!")});const le=document.getElementById("form-register");le&&le.addEventListener("submit",async t=>{t.preventDefault();const e=document.getElementById("inp-reg-nome").value.trim(),o=document.getElementById("inp-reg-email").value.trim(),a=document.getElementById("inp-reg-password").value,n=document.getElementById("inp-reg-cartao1").value.trim()||"Cartão 1",s=document.getElementById("inp-reg-cartao2").value.trim()||"Cartão 2";if(o.toLowerCase()===C.toLowerCase()||o.toLowerCase()==="admin@controlefinanceiro.com"){if(a!==ge){toastMsg("❌ A senha para a conta do Administrador deve ser: 220101cod");return}const f="admin_victor_uid",b={uid:f,email:C,nomeUsuario:e||"Victor (Admin)",role:"admin",status:"ativo",nomeCartao1:n,nomeCartao2:s};try{await M(y(p,$,f),{...b,createdAt:F()},{merge:!0})}catch(v){console.warn("Aviso DB Admin ao cadastrar:",v)}se(b),await H(b,"👑 Conta de Administrador autenticada!");return}const r="usr_"+Date.now(),l={uid:r,email:o,nomeUsuario:e,nomeCartao1:n,nomeCartao2:s,role:"user",status:"pendente",createdAt:F()};try{await M(y(p,$,r),l)}catch(f){console.warn("Aviso DB Usuário ao cadastrar:",f)}se(l),toastMsg("🎉 Cadastro enviado! Sua conta está aguardando aprovação pelo Administrador (victorhomota@gmail.com).")});window.fazerLogout=async function(){if(confirm("Deseja realmente sair da sua conta?")){localStorage.removeItem("cf_custom_session");try{await Ce(ue)}catch{}u=null,m=null,ae(),document.getElementById("modal-auth").style.display="flex",document.getElementById("user-profile-bar").style.display="none",toastMsg("🚪 Você saiu da conta.")}};window.selecionarCartaoFaturaBtn=function(t){const e=document.getElementById("select-fatura-cartao-nome");e&&(e.value=t);const o=document.getElementById("btn-cartao1-fatura"),a=document.getElementById("btn-cartao2-fatura");o&&a&&m&&(t===m.nomeCartao1?(o.style.background="linear-gradient(135deg, #c084fc, #9333ea)",o.style.borderColor="#c084fc",o.style.color="#fff",a.style.background="rgba(15,23,42,0.6)",a.style.borderColor="var(--border-color)",a.style.color="var(--text-muted)"):(a.style.background="linear-gradient(135deg, #fb7185, #e11d48)",a.style.borderColor="#fb7185",a.style.color="#fff",o.style.background="rgba(15,23,42,0.6)",o.style.borderColor="var(--border-color)",o.style.color="var(--text-muted)"))};function xe(){const t=document.getElementById("container-botoes-cartao-fatura");if(!t||!m)return;const e=m.nomeCartao1||"Cartão 1",o=m.nomeCartao2||"Cartão 2";t.innerHTML=`
      ...
      `,selecionarCartaoFaturaBtn(e)}async function oe(t){try{const a=await P(D(T(p,$),R("uid","==",t)));if(!a.empty)m=a.docs[0].data();else{const n=u.email&&u.email.toLowerCase()===C.toLowerCase()||u.email==="admin@controlefinanceiro.com";m={uid:t,email:u.email,nomeUsuario:n?"Victor (Admin)":u.nomeUsuario||"Usuário",nomeCartao1:u.nomeCartao1||"Cartão 1",nomeCartao2:u.nomeCartao2||"Cartão 2",role:n?"admin":"user",status:n?"ativo":u.status||"pendente"}}}catch(a){console.warn("Usando dados da sessão local para o perfil:",a);const n=u.email&&u.email.toLowerCase()===C.toLowerCase()||u.email==="admin@controlefinanceiro.com";m={uid:t,email:u.email,nomeUsuario:u.nomeUsuario||(n?"Victor (Admin)":"Usuário"),nomeCartao1:u.nomeCartao1||"Cartão 1",nomeCartao2:u.nomeCartao2||"Cartão 2",role:n?"admin":"user",status:n?"ativo":u.status||"pendente"}}m.email&&(m.email.toLowerCase()===C.toLowerCase()||m.email==="admin@controlefinanceiro.com")&&(m.role="admin",m.status="ativo"),document.getElementById("txt-user-name").textContent=m.nomeUsuario||"Usuário",document.getElementById("txt-user-email").textContent=m.email||"",document.getElementById("txt-user-avatar").textContent=(m.nomeUsuario||"U").charAt(0).toUpperCase(),document.getElementById("lbl-entrada-nome").textContent=`Descrição da Entrada / Salário de ${m.nomeUsuario}:`,document.getElementById("inp-entrada-desc").placeholder=`Ex: Salário de ${m.nomeUsuario}`,xe(),document.getElementById("btn-nav-admin");const e=document.querySelectorAll(".nav-tab");m.role==="admin"||m.email&&(m.email.toLowerCase()===C.toLowerCase()||m.email==="admin@controlefinanceiro.com")?(e.forEach(a=>{a.getAttribute("data-tab")==="tab-admin"?a.style.display="flex":a.style.display="none"}),goTab("tab-admin"),Z()):e.forEach(a=>{a.getAttribute("data-tab")==="tab-admin"?a.style.display="none":a.style.display="flex"})}window.abrirModalPerfil=function(){m&&(document.getElementById("inp-perf-nome").value=m.nomeUsuario||"",document.getElementById("inp-perf-cartao1").value=m.nomeCartao1||"",document.getElementById("inp-perf-cartao2").value=m.nomeCartao2||"",document.getElementById("modal-perfil").style.display="flex")};window.fecharModalPerfil=function(){document.getElementById("modal-perfil").style.display="none"};document.getElementById("form-atualizar-perfil").addEventListener("submit",async t=>{if(t.preventDefault(),!u)return;const e=document.getElementById("inp-perf-nome").value.trim(),o=document.getElementById("inp-perf-cartao1").value.trim(),a=document.getElementById("inp-perf-cartao2").value.trim();try{await M(y(p,$,u.uid),{...m,nomeUsuario:e,nomeCartao1:o,nomeCartao2:a},{merge:!0}),m.nomeUsuario=e,m.nomeCartao1=o,m.nomeCartao2=a,await oe(u.uid),fecharModalPerfil(),toastMsg("✅ Perfil e nome dos cartões atualizados!"),k()}catch(n){toastMsg("❌ Erro ao atualizar perfil: "+n.message)}});function fe(t){ae(),W=V(D(T(p,ee),R("userId","==",t)),e=>{S=e.docs.map(o=>({id:o.id,...o.data()})),k()}),X=V(D(T(p,_),R("userId","==",t)),e=>{x=e.docs.map(o=>({id:o.id,...o.data()})),k()}),Y=V(D(T(p,te),R("userId","==",t)),e=>{B=e.docs.map(o=>({id:o.id,...o.data()})),k()}),Q=V(y(p,pe,t),e=>{e.exists()?U=e.data():U={metaAnual:15e3,valorAtualGuardado:3e3},k()})}function ae(){W&&W(),X&&X(),Y&&Y(),Q&&Q()}function k(){Te(),ve(),Le(),Se(),ze()}function re(){const t=new Set;if(S.forEach(e=>{e.mesAno&&t.add(e.mesAno)}),x.forEach(e=>{e.mesAno&&t.add(e.mesAno)}),B.forEach(e=>{e.mesAno&&t.add(e.mesAno)}),t.size===0){const e=new Date;t.add(`${e.getFullYear()}-${String(e.getMonth()+1).padStart(2,"0")}`)}return Array.from(t).sort((e,o)=>o.localeCompare(e))}function Te(){const t=U&&U.metaAnual!==void 0?U.metaAnual:15e3,e=U&&U.valorAtualGuardado!==void 0?U.valorAtualGuardado:3e3,o=document.getElementById("inp-meta-anual");o&&document.activeElement!==o&&(o.value=t);const a=document.getElementById("inp-saldo-guardado");a&&document.activeElement!==a&&(a.value=e);const s=new Date().getMonth()+1,i=Math.max(1,12-s+1),r=Math.max(0,t-e),l=r>0?r/i:0;document.getElementById("val-meta-reserva").textContent=brl(l);const f=document.getElementById("subtext-meta-reserva");f&&(f.textContent=`Faltam ${brl(r)} p/ Meta Anual de ${brl(t)} (${i} mês(es) até o fim do ano)`),document.getElementById("val-real-guardado").textContent=brl(e);const b=re(),v=Math.max(1,b.length);let w=0,d=0,c=0;b.forEach(O=>{w+=S.filter(A=>A.mesAno===O).reduce((A,h)=>A+(h.valor||0),0),d+=x.filter(A=>A.mesAno===O).reduce((A,h)=>A+(h.valorTotal!==void 0?h.valorTotal:h.valor||0),0),c+=B.filter(A=>A.mesAno===O).reduce((A,h)=>A+(h.valorTotal!==void 0?h.valorTotal:h.valor||0),0)});const E=d+c,g=w-E,I=w/v,z=E/v,N=g/v,j=N>0?N:0,be=j*i,L=e+be;document.getElementById("val-recomendacao-reserva").textContent=brl(L);const K=document.getElementById("subtext-recomendacao");if(K)if(L>=t)K.innerHTML=`✅ Projeção de <strong style="color:#34d399">${brl(L)}</strong> até Dezembro supera sua Meta Anual de ${brl(t)}!`;else{const O=t-L;K.innerHTML=`⚠️ Sobra média de ${brl(j)}/mês. Projeção de ${brl(L)} fica <strong style="color:#fb7185">${brl(O)}</strong> abaixo da Meta de ${brl(t)}.`}const J=document.getElementById("box-analise-reserva-detalhes");if(J)if(w===0)J.innerHTML='<p class="empty-state">Cadastre seus salários e entradas na aba "Salários & Entradas" para gerar o diagnóstico financeiro inteligente.</p>';else{const O=t>0?Math.min(100,e/t*100).toFixed(1):0,A=L>=t;let h="";A?h=`
            ...
            <div style="background:rgba(15,23,42,0.6);padding:1.1rem;border-radius:10px;margin:.75rem 0;border:1px solid var(--border-color)">
              <div style="display:flex;justify-content:space-between;align-items:center;margin-bottom:.6rem;flex-wrap:wrap;gap:.75rem">
                <div>
                  ...
                  <strong style="font-size:1.15rem;color:${g>=0?"#60a5fa":"#fb7185"}">${brl(g)}</strong>
                </div>
                <div>
            ...
            ${h}
          `}Me()}const de=document.getElementById("form-config-reservas");de&&de.addEventListener("submit",async t=>{if(t.preventDefault(),!u)return;const e=document.getElementById("inp-meta-anual"),o=document.getElementById("inp-saldo-guardado"),a=e&&parseFloat(e.value)||0,n=o&&parseFloat(o.value)||0;try{await M(y(p,pe,u.uid),{userId:u.uid,metaAnual:a,valorAtualGuardado:n,updatedAt:F()}),toastMsg("✅ Metas e Saldo Guardado salvos!")}catch(s){toastMsg("❌ Erro ao salvar reservas: "+s.message)}});function Me(){const t=document.getElementById("container-analise-mensal-lista");if(!t)return;const e=re();if(!e.length){t.innerHTML='<div class="empty-state">Nenhum mês registrado ainda.</div>';return}t.innerHTML=e.map(o=>{const a=S.filter(d=>d.mesAno===o).reduce((d,c)=>d+(c.valor||0),0),n=x.filter(d=>d.mesAno===o).reduce((d,c)=>d+(c.valorTotal!==void 0?c.valorTotal:c.valor||0),0),s=B.filter(d=>d.mesAno===o).reduce((d,c)=>d+(c.valorTotal!==void 0?c.valorTotal:c.valor||0),0),i=n+s,r=a-i;let[l,f]=o.split("-"),v=new Date(parseInt(l),parseInt(f)-1,1).toLocaleString("pt-BR",{month:"long"});return`
        ...
        `}).join("")}function ve(){const t=document.getElementById("select-mes-controle");if(!t)return;const e=re(),o=t.value;t.innerHTML=e.map(d=>{let[c,E]=d.split("-"),I=new Date(parseInt(c),parseInt(E)-1,1).toLocaleString("pt-BR",{month:"long"}),z=`${I.charAt(0).toUpperCase()+I.slice(1)}/${c}`;return`<option value="${d}">${z}</option>`}).join(""),o&&e.includes(o)?t.value=o:e.length>0&&(t.value=e[0]);const a=t.value;if(!a)return;const n=S.filter(d=>d.mesAno===a),s=x.filter(d=>d.mesAno===a),i=B.filter(d=>d.mesAno===a),r=n.reduce((d,c)=>d+(c.valor||0),0),l=s.reduce((d,c)=>d+(c.valorTotal!==void 0?c.valorTotal:c.valor||0),0),f=i.reduce((d,c)=>d+(c.valorTotal!==void 0?c.valorTotal:c.valor||0),0),b=l+f,v=r-b;document.getElementById("cm-val-entradas").textContent=brl(r),document.getElementById("cm-val-saidas").textContent=brl(b),document.getElementById("cm-val-saldo").textContent=brl(v);const w=document.getElementById("container-detalhes-controle-mensal");w.innerHTML=`
      ...
      `}window.renderControleMensal=ve;function Le(){const t=document.getElementById("lista-entradas-registradas"),e=S.reduce((o,a)=>o+(a.valor||0),0);if(document.getElementById("badge-total-entradas").textContent=`${brl(e)} total`,!S.length){t.innerHTML='<div class="empty-state">Nenhuma entrada cadastrada ainda.</div>';return}t.innerHTML=`<div class="table-responsive"><table class="custom-table">
      ...
      `}function Se(){const t=x.reduce((i,r)=>i+(r.valorTotal!==void 0?r.valorTotal:r.valor||0),0);document.getElementById("badge-total-cartoes").textContent=`${brl(t)} total`;const e=document.getElementById("lista-faturas-registradas");if(!x.length){e.innerHTML='<div class="empty-state">Nenhuma fatura cadastrada ainda.</div>';return}const o=Ue(x),a={};x.forEach(i=>{const r=i.mesAno||"Outros";a[r]||(a[r]=[]),a[r].push(i)});const s=Object.keys(a).sort((i,r)=>r.localeCompare(i)).map((i,r)=>{const l=a[i],f=l.reduce((g,I)=>g+(I.valorTotal!==void 0?I.valorTotal:I.valor||0),0);let[b,v]=i.split("-"),d=new Date(parseInt(b),parseInt(v)-1,1).toLocaleString("pt-BR",{month:"long"}),c=`${d.charAt(0).toUpperCase()+d.slice(1)} de ${b}`;const E=r===0;return`
          <div class="card" style="margin-bottom:1.25rem;background:rgba(15,23,42,0.45);border:1px solid var(--border-color)">
            ...
            <div id="fat-group-${i}" class="purchase-details ${E?"open":""}" style="padding:.75rem 1rem;display:${E?"block":"none"}">
              ${l.map(g=>{var j;const I=g.valorTotal!==void 0?g.valorTotal:g.valor||0,z=g.cartao||(m==null?void 0:m.nomeCartao1)||"Cartão 1",N=g.dataVencimento?fmtData(g.dataVencimento).split(",")[0]:"—";return`
                  <div class="purchase-card" style="margin-bottom:1rem; background:rgba(30,41,59,0.7); border-radius:10px; padding:1rem; border:1px solid var(--border-color)">
                    <div style="display:flex; justify-content:space-between; align-items:center; flex-wrap:wrap; gap:.5rem">
                      <div>
                        ...
                        <p style="font-size:.78rem; color:var(--text-muted); margin-top:.2rem">📅 Mês Referência: <strong>${g.mesAno}</strong> • 🛒 ${g.qtdItens||((j=g.itens)==null?void 0:j.length)||1} itens</p>
                      </div>
                      <div style="display:flex; align-items:center; gap:.75rem">
                        <div style="text-align:right">
                        ...
                        <button type="button" class="btn-danger" onclick="excluirFaturaDocumento('${g.id}')">🗑️ Excluir</button>
                      </div>
                    </div>
                    ${De(g)}
                  </div>
        ...
        `}).join("");e.innerHTML=o+s}function De(t){return t.itens&&t.itens.length>0?`
      ...
      `}function ze(){const t=B.reduce((n,s)=>n+(s.valorTotal!==void 0?s.valorTotal:s.valor||0),0);document.getElementById("badge-total-boletos").textContent=`${brl(t)} total`,Re(B);const e=document.getElementById("lista-boletos-registrados");if(!B.length){e.innerHTML='<div class="empty-state">Nenhum boleto cadastrado ainda.</div>';return}const o={};B.forEach(n=>{const s=n.mesAno||"Outros";o[s]||(o[s]=[]),o[s].push(n)});const a=Object.keys(o).sort((n,s)=>s.localeCompare(n));e.innerHTML=a.map((n,s)=>{const i=o[n],r=i.reduce((c,E)=>c+(E.valorTotal!==void 0?E.valorTotal:E.valor||0),0);let[l,f]=n.split("-"),v=new Date(parseInt(l),parseInt(f)-1,1).toLocaleString("pt-BR",{month:"long"}),w=`${v.charAt(0).toUpperCase()+v.slice(1)} de ${l}`;const d=s===0;return`
          <div class="card" style="margin-bottom:1.25rem;background:rgba(15,23,42,0.45);border:1px solid var(--border-color)">
            ...
            <div id="bol-group-${n}" class="purchase-details ${d?"open":""}" style="padding:.75rem 1rem;display:${d?"block":"none"}">
              ${i.map(c=>{const E=c.valorTotal!==void 0?c.valorTotal:c.valor||0,g=c.dataVencimento?fmtData(c.dataVencimento).split(",")[0]:"—";return`
                  <div class="purchase-card" style="margin-bottom:1rem; background:rgba(30,41,59,0.7); border-radius:10px; padding:1rem; border:1px solid var(--border-color)">
                    <div style="display:flex; justify-content:space-between; align-items:center; flex-wrap:wrap; gap:.5rem">
                      <div>
                        <h3><span class="badge purple">📄 ${q(c)}</span> — Vencimento: ${g}</h3>
        ...
        `}).join("")}window.toggleGroupMonth=function(t){const e=document.getElementById(t),o=document.getElementById("chev-"+t);if(!e)return;const a=e.style.display==="none"||!e.style.display;e.style.display=a?"block":"none",o&&(a?o.classList.add("open"):o.classList.remove("open"))};window.excluirBoletoDocumento=async function(t){if(confirm("Excluir este boleto?"))try{await G(y(p,te,t)),toastMsg("🗑️ Boleto removido.")}catch(e){toastMsg("Erro: "+e.message)}};window.editarValorBoletoDocumento=function(t){const e=B.find(o=>o.id===t);e&&(document.getElementById("inp-edit-boleto-id").value=t,document.getElementById("inp-edit-boleto-desc").value=q(e),document.getElementById("inp-edit-boleto-val").value=e.valorTotal!==void 0?e.valorTotal:e.valor||0,document.getElementById("modal-editar-boleto").style.display="flex")};window.fecharModalEditarBoleto=function(){document.getElementById("modal-editar-boleto").style.display="none"};document.getElementById("form-editar-boleto").addEventListener("submit",async t=>{t.preventDefault();const e=document.getElementById("inp-edit-boleto-id").value,o=document.getElementById("inp-edit-boleto-desc").value.trim(),a=parseFloat(document.getElementById("inp-edit-boleto-val").value)||0,n=B.find(s=>s.id===e);if(n)try{await M(y(p,te,e),{...n,descricao:o,valorTotal:a,valor:a}),fecharModalEditarBoleto(),toastMsg("✅ Boleto atualizado!")}catch(s){toastMsg("❌ Erro ao atualizar boleto: "+s.message)}});async function Z(){try{let t=[];try{t=(await P(T(p,$))).docs.map(l=>l.data())}catch(r){console.warn("Aviso ao consultar usuários no Firestore:",r)}t.some(r=>r.email&&r.email.toLowerCase()===C.toLowerCase())||t.unshift({uid:"admin_victor_uid",email:C,nomeUsuario:"Victor (Admin)",nomeCartao1:"Cartão Principal",nomeCartao2:"Cartão Secundário",role:"admin",status:"ativo"});const e=t.filter(r=>r.status==="ativo"||r.role==="admin").length,o=t.filter(r=>r.status==="pendente"&&r.role!=="admin").length,a=document.getElementById("admin-kpi-users"),n=document.getElementById("admin-kpi-ativos"),s=document.getElementById("admin-kpi-pendentes");a&&(a.textContent=t.length),n&&(n.textContent=e),s&&(s.textContent=o);const i=document.getElementById("admin-lista-usuarios");if(!i)return;i.innerHTML=t.map(r=>{const l=r.role==="admin"||r.email&&r.email.toLowerCase()===C.toLowerCase(),f=r.status==="pendente"&&!l;return`
          ...
          `}).join("")}catch(t){console.error("Erro no painel admin:",t)}}async function Ne(t){if(t)try{await M(y(p,$,t),{status:"ativo"},{merge:!0}),toastMsg("✅ Cadastro de usuário APROVADO! O acesso foi liberado."),Z()}catch(e){toastMsg("❌ Erro ao aprovar usuário: "+e.message)}}window.aprovarUsuarioAdmin=Ne;async function je(t){if(t)try{let e=null;try{const o=await P(D(T(p,$),R("uid","==",t)));o.empty||(e=o.docs[0].data())}catch{}e||(e={uid:t,nomeUsuario:"Usuário",email:"usuario@email.com",nomeCartao1:"Cartão 1",nomeCartao2:"Cartão 2",status:"ativo",role:"user"}),document.getElementById("admin-edit-user-uid").value=e.uid,document.getElementById("admin-edit-user-nome").value=e.nomeUsuario||"",document.getElementById("admin-edit-user-email").value=e.email||"",document.getElementById("admin-edit-user-cartao1").value=e.nomeCartao1||"",document.getElementById("admin-edit-user-cartao2").value=e.nomeCartao2||"",document.getElementById("admin-edit-user-status").value=e.status||"ativo",document.getElementById("admin-edit-user-role").value=e.role||"user",document.getElementById("modal-editar-usuario-admin").style.display="flex"}catch(e){toastMsg("Erro ao abrir edição do usuário: "+e.message)}}window.abrirModalEditarUsuarioAdmin=je;function ne(){document.getElementById("modal-editar-usuario-admin").style.display="none"}window.fecharModalEditarUsuarioAdmin=ne;const ce=document.getElementById("form-editar-usuario-admin");ce&&ce.addEventListener("submit",async t=>{t.preventDefault();const e=document.getElementById("admin-edit-user-uid").value,o=document.getElementById("admin-edit-user-nome").value.trim(),a=document.getElementById("admin-edit-user-email").value.trim(),n=document.getElementById("admin-edit-user-cartao1").value.trim(),s=document.getElementById("admin-edit-user-cartao2").value.trim(),i=document.getElementById("admin-edit-user-status").value,r=document.getElementById("admin-edit-user-role").value;try{await M(y(p,$,e),{uid:e,nomeUsuario:o,email:a,nomeCartao1:n,nomeCartao2:s,status:i,role:r},{merge:!0}),ne(),toastMsg("✅ Dados do usuário atualizados com sucesso!"),Z()}catch(l){toastMsg("❌ Erro ao atualizar usuário: "+l.message)}});async function ye(t,e){if(confirm(`Deseja realmente excluir permanentemente o cadastro do usuário "${e}"?`))try{await G(y(p,$,t)),toastMsg(`🗑️ Usuário "${e}" excluído do sistema.`),Z()}catch(o){toastMsg("❌ Erro ao excluir usuário: "+o.message)}}window.excluirUsuarioAdminDirect=ye;async function ke(){const t=document.getElementById("admin-edit-user-uid").value,e=document.getElementById("admin-edit-user-nome").value;t&&(await ye(t,e),ne())}window.excluirUsuarioAdminConfirmado=ke;async function Fe(t){if(t)try{let e=null;try{const n=await P(D(T(p,$),R("uid","==",t)));n.empty||(e=n.docs[0].data())}catch{}e||(e={uid:t,email:t==="admin_victor_uid"?C:"usuario@sistema.com",nomeUsuario:t==="admin_victor_uid"?"Victor (Admin)":"Usuário",role:t==="admin_victor_uid"?"admin":"user",status:t==="admin_victor_uid"?"ativo":"pendente",nomeCartao1:"Cartão 1",nomeCartao2:"Cartão 2"});let o="Data não registrada";if(e.createdAt)try{o=e.createdAt.toDate?e.createdAt.toDate().toLocaleString("pt-BR"):"Recente"}catch{o="Recente"}const a=document.getElementById("admin-user-details-content");a.innerHTML=`
        ...
        `,document.getElementById("modal-inspecionar-usuario").style.display="flex"}catch(e){toastMsg("❌ Erro ao exibir detalhes do usuário: "+e.message)}}window.inspecionarUsuarioAdmin=Fe;function Pe(){document.getElementById("modal-inspecionar-usuario").style.display="none"}window.fecharModalInspecionarUsuario=Pe;
